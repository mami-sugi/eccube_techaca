        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="finish_year" <!--{if $arrErr.finish_year || $arrErr.finish_month || $arrErr.finish_day }-->style="background-color:<!--{$smarty.const.ERR_COLOR|h}-->"<!--{/if}-->>
                    <option value="" selected="selected">----</option>
    ...
    <form name="move" id="move" method="post" action="?">
        ...
        <table class="list">
            ...
            <tr style="background:<!--{if $arrNews[data].news_id != $tpl_news_id}-->#ffffff<!--{else}--><!--{$smarty.const.SELECT_RGB}--><!--{/if}-->;" class="center">
                ...
                <td><!--{$arrNews[data].cast_finish_date|date_format:"%Y/%m/%d"}--></td>
                <td class="left">
